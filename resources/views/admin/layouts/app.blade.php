...
<head>
    ...
    <title>{{ $page_title ?? 'Dashboard'}} - My - Path</title>
    <link rel="icon" type="image/png" href="{{url('images/test3.png')}}" />
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 copy-right" >
                        {{date('Y')}} &copy; My - Path by <a href="#" target="_blank">fastabee`s team</a>
                    </div>
                    <div class="col-md-6">
