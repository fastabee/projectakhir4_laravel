                        ...
                        <div class="col-xs-12  col-md-7 col-lg-6">
                            <div class="media ">
                                ...
                                <div class="media-body">
                                    <h4 class="media-heading">{{__("Dapatkan Pembaruan Tempat Indah Setiap harinya")}}</h4>
                                    <p>{{__("Silahkan Berikan Saran Tempat Untuk Membantu Kami")}}</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-md-5 col-lg-6">
                            <form action="{{route('newsletter.subscribe')}}" class="subcribe-form bravo-subscribe-form bravo-form">
                                ...
                                <div class="form-group">
                                    <input type="text" name="email" class="form-control email-input" placeholder="{{__('email anda')}}">
