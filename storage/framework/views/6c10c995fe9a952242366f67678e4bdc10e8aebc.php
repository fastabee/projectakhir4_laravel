<?php if(!empty($seo_meta)): ?>
    ...
    <?php endif; ?>
    <title><?php echo e($seo_meta['seo_title'] ?? $seo_meta['service_title'] ?? $page_title ?? ""); ?> - My-Path</title>
...
<?php else: ?>
    <title><?php echo e($page_title ?? ''); ?> - My-Path</title>
    <meta name="description" content="<?php echo e(setting_item("site_desc")); ?>"/>
<?php endif; ?>
<?php /**PATH D:\new laravel\booking1\resources\views/layouts/parts/seo-meta.blade.php ENDPATH**/ ?>