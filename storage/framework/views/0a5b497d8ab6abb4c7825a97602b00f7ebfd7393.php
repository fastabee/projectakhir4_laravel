...
<head>
    ...
    <title><?php echo e($page_title ?? 'Dashboard'); ?> - My - Path</title>
    <link rel="icon" type="image/png" href="<?php echo e(url('images/test3.png')); ?>" />
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 copy-right" >
                        <?php echo e(date('Y')); ?> &copy; My - Path by <a href="#" target="_blank">fastabee`s team</a>
                    </div>
                    <div class="col-md-6">
...
<?php /**PATH D:\new laravel\booking1\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>