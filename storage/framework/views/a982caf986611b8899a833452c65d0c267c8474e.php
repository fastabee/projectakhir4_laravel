...
<div class="header-logo flex-shrink-0">
    <h3 class="logo-text"><a href="<?php echo e(url('/admin')); ?>">MY - PATH v.<span><?php echo e(config('app.version')); ?></span></a></h3>
</div>
...
<?php /**PATH D:\new laravel\booking1\resources\views/admin/layouts/parts/header.blade.php ENDPATH**/ ?>