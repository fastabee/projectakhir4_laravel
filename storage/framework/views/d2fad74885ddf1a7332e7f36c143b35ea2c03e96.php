            ...
            <div class="topbar-left">
                ...
                <?php if($admin_email = setting_item("admin_email")): ?>
                    <ul class="topbar-items">
                        <li class="hidden-xs hidden-sm"><a href="mailto:<?php echo e($admin_email); ?>" target="">fastabikul87@polije.com</a>
                        </li>
                    </ul>
                <?php endif; ?>
            </div>
...
<?php /**PATH D:\new laravel\booking1\resources\views/layouts/parts/topbar.blade.php ENDPATH**/ ?>